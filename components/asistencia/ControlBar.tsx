...
const Select: React.FC<React.SelectHTMLAttributes<HTMLSelectElement>> = (props) => (
    <div className="relative">
        <select {...props} className={`appearance-none px-4 py-2 text-base font-bold bg-slate-200/80 dark:bg-slate-700/60 text-slate-700 dark:text-slate-200 rounded-lg border-none focus:ring-2 focus:ring-indigo-500 transition disabled:opacity-50 disabled:cursor-not-allowed ${props.className || ''}`} />
